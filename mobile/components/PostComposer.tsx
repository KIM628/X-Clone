      ...
      {selectedImage && (
        <View className="mt-3 ml-15">
          <View className="relative">
            ...
            />
            <TouchableOpacity
              className="absolte top-2 right-2 w-8 h-8 bg-black bg-opacity-60 rounded-full items-center justify-center"
              onPress={removeImage}
            >
        ...
        <View className="flex-row items-center">
          ...
          <TouchableOpacity
            className={`px-6 py-2 rounded-full ${
              content.trim() || selectedImage ? "bg-blue-500" : "bg-gray-500"
            }`}
          >
            {isCreating ? (
