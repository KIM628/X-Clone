...
const MessagesScreen = () => {
  ...
  const deleteConversation = (consversationId: number) => {
    Alert.alert(
      "Delete Conversation",
      "Are you sure you want to delete thos conversation?",
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            setConversationsList((prev) =>
              prev.filter((conv) => conv.id !== consversationId)
            );
          },
        },
      ]
                ...
                {selectedConversation.messages.map((message) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <Text className="text-xs text-gray-400 m-1">
                        {message.time}
                      </Text>
                    </View>
                  </View>
